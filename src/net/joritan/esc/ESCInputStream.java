...
public class ESCInputStream
{
    ...
    public byte readByte()
    {
        ...
        {
            new BlueScreen(null, e, new String[] {"ESCInputStream failed to read"});
        }
        return 0;
    }
    ...
    public int readLong()
    {
        ...
        {
            stream.read(buff8);
            return buff8[0] << 56 | buff8[1] << 48 | buff8[2] << 40 | buff8[3] << 32 | buff8[4] << 24 | buff8[5] << 16 | buff8[6] << 8 | buff8[7];
        }
        catch (IOException e)
        {
            new BlueScreen(null, e, new String[] {"ESCInputStream failed to read"});
    ...
    public void close()
    {
        ...
        {
            new BlueScreen(null, e, new String[] {"ESCInputStream failed to close"});
        }
    }
}
